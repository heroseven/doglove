        ...
        <div class="panel panel-default table-responsive">
            ...
            <tbody> 
             @foreach($productos as $producto)
                <tr>
                        <td><input tabindex="1" type="checkbox" name="productos[]" id="{{$producto}}" value="{{$producto->id}}"></td>
            ...
            <input class="btn btn-default pull-right" type="submit" value="Hacer pedido">
        </form>
